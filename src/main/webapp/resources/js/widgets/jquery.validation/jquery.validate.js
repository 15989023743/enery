...
(function(c) {
	...
	c.extend(c.validator, {
		...
		messages: {
			...
			mobile: "Please enter a valid mobile tel.",
			tel: "Please enter a valid tel.",
			url: "Please enter a valid URL.",
			date: "Please enter a valid date.",
			dateISO: "Please enter a valid date (ISO).",
			number: "Please enter a valid number.",
            carNum:"Please enter a valid carNum",
            ...
            decimal: c.validator.format("Please enter a number {0} decimal")
		...
		methods: {
			...
			mobile: function(a, b) {
				//return this.optional(b) || /^(((13[0-9]{1})|(15[0-9]{1}))+\d{8})$/.test(a)
				return this.optional(b) || /^1{1}\d{10}$/.test(a)
			},
			tel: function(a, b) {
				return this.optional(b) || /^\d{3,4}-?\d{7,9}$/.test(a)
			},
			zipCode: function(a, b) {
				return this.optional(b) || /^[0-9]{6}$/.test(a)
			},
            ...
            carNum:function(a,b){
                return this.optional(b) || /^[\u4e00-\u9fa5]{1}[A-Z]{1}[A-Z_0-9]{5}$/.test(a)
            },
            decimal:function(a,b,d){
            	//return this.optional(b) || \d{1,8}\.{0,1}\d{0,2}$/.test(a)
            	//return this.optional(b) || /^-?\d+\.?\d{0,2}$/.test(a)
            	return this.optional(b) || /^-{0,1}\d+\.{0,1}\d{0,2}$/.test(a)
            },
			digits: function(a, b) {
				//return this.optional(b) || /^-?\d+\.?\d{0,d}$/.test(a)
