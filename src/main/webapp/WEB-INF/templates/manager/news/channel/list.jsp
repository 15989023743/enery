...
<form id="ListForm" name="ListForm" action="${ctx}/center/news/channel/" method="post" >
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
              <tr>
                ...
                <td width="35%"><b><quick:navigation name="新闻频道管理" /></b></td>
   ...
   <td height="18">
      ...
      <tr>
        ...
        <table style="width:100%" align="center" class="TableBlock1" >
		   ...
		   <tr>
		    <td nowrap class="TableContent" width="12%" align="center">频道名称</td>
		    ...
		    <td nowrap class="TableData" colspan="3"><input type="text" name="filter_LIKE_note" value="${param['filter_LIKE_note']}"  class="SmallInput" style="width:97%" maxlength="30" size="30"/></td> 
		   </tr>
		   <tr>
			<td align="center" class="TableContent" colspan="6">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="SmallButton" name="b_act_new" onclick="add('${parentid}')" value="新&nbsp;&nbsp;增" style="width:60" />
				</acl:method>
			</td>
		   </tr>		   		   
		</table>
        ...
        <table style="width:100%" align="center" class="TableBlock1" onmousemove="changeto()" onmouseout="changeback()">
          <tr align="center">
            ...
            <td width="3%" class="TableHeader1"><a href="#" onclick="sort('id')">代号</a></td>
            <td width="12%" class="TableHeader1"><a href="#" onclick="sort('name')">频道名称</a></td>
            <td width="10%" class="TableHeader1">创建下级频道</td>
            <td width="10%" class="TableHeader1">所属频道</td>
            <td width="30%" class="TableHeader1">备注</td>
          ...
          <tr>
            ...
            <td class="TableData"><a href='${ctx}/center/news/channel/?parentid=${e.id}'>${e.name}</a><c:if test="${fn:length(e.children)>0}"><font color=red>(有${fn:length(e.children)}个子类)</font></c:if>
            </td>
            <td class="TableData">
            <acl:method action="create">
            <a href="#" onclick="add('${e.id}')">创建子类别</a>
            </acl:method>
            </td>
            <td class="TableData"><c:if test="${!empty e.parent}">${e.parent.name}</c:if></td>
            <td class="TableData">${e.note}</td>
          ...
          <c:set var="superid" value="${e.parent.parent.id}" scope="request" />
          </c:forEach>
        </table>
		<!--业务表格区域结束-->
      </td>
 ...
 <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="TableRound">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
          <tr>
            <td>&nbsp;&nbsp;共有${page.totalCount}条记录，当前第 ${page.pageNo}/${page.totalPages}页&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" class="SmallButton" name="b_act_return" onclick="javascript:window.location.href='${ctx}/center/news/channel/?parentid=${superid}'" value="返上一层" style="width:60" /></td>
            <td>${page.pageBar}</td>
          </tr>
        </table>
        </td>
