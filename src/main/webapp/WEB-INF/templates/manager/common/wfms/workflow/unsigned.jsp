...
<form id="ListForm" name="ListForm" action="${ctx}/center/common/wfms/workflow/unsigned" method="post" >
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
              <tr>
                ...
                <td width="35%"><b><quick:navigation name="签收任务" /></b></td>
      ...
      <tr>
        ...
        <table style="width:100%" align="center" class="TableBlock1" onmousemove="changeto()" onmouseout="changeback()">
          ...
          <tr>
			...
			<a href="#" onclick="command('${e.id}','claim')">签收</a>
			</td>
          </tr>
          </c:forEach>
        </table>
