...
<form id="ListForm" name="ListForm" action="${ctx}/center/common/wfms/processInstance/" method="post" >
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
              <tr>
                ...
                <td width="35%"><b><quick:navigation name="流程实例管理" /></b></td>
      ...
      <tr>
        ...
        <table style="width:100%" align="center" class="TableBlock1" onmousemove="changeto()" onmouseout="changeback()">
          <tr align="center">
			...
			<td width="15%" class="TableHeader1"><a href="#" onclick="sort('name')">流程名称</a></td>
			<td width="6%" class="TableHeader1"><a href="#" onclick="sort('id')">实例ID</a></td>
            <td width="16%"  class="TableHeader1"><a href="#" onclick="sort('start')">启动时间</a></td>
            <td width="16%"  class="TableHeader1"><a href="#" onclick="sort('end')">结束时间</a></td>
            <td width="4%"  class="TableHeader1"><a href="#" onclick="sort('starter')">启动者</a></td>
            <td width="14%" class="TableHeader1">操作</td>
          </tr>
          <c:forEach items="${page.result}" var="e" varStatus="s">
          <tr>
            <td class="TableData" align="center">${s.index+page.first}</td>
			<td class="TableData">${e.pdname}</td>
			...
			<td class="TableData">${e.starter}</td>
            <td class="TableData" align="center">
			<a href="#" onclick="command('${e.id}','image')">流程跟踪</a>
			、<a href="export.action?id=${id}" target="_blank">查看任务实例</a>
			</td>
          </tr>
          </c:forEach>
        </table>
