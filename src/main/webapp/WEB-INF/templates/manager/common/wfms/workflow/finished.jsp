...
<form id="ListForm" name="ListForm" action="${ctx}/center/common/wfms/workflow/finished" method="post" >
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
              <tr>
                ...
                <td width="35%"><b><quick:navigation name="任务存档" /></b></td>
      ...
      <tr>
        ...
        <table style="width:100%" align="center" class="TableBlock1" onmousemove="changeto()" onmouseout="changeback()">
          <tr align="center">
            ...
            <td width="6%" class="TableHeader1">操作</td>
          </tr>
          ...
          <tr>
            ...
            <td class="TableData" align="center">
				<a href="traceProcess?piid=${e.processInstanceId}" target="_blank">流程跟踪</a>
			</td>
          </tr>
          </c:forEach>
        </table>
