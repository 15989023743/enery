...
function GetResult() 
{
	...
	oBao.open("post","http://"+ip+"/"+webname+"/PrjReonloadAction.do?function=prjList",false); 
	...
	document.write("<tr height=24 ><td valign=middle class=tablebody2 align=center width=15%><b>序号</b></td><td valign=middle class=tablebody2 align=center width=70%><b>工程名</b></td><td valign=middle class=tablebody2 align=center  width=15%><b>删除</b></td></tr>");
	for(var i=0;i<arraystr.length-1;i++){
		document.write("<tr height=24 ><td valign=middle class=tablebody2 align=center>"+(i+1)+"</td><td valign=middle class=tablebody2 align=left>"+arraystr[i]+"</td><td valign=middle class=tablebody2 align=center><input type='button' value=' 删 除 ' onclick=delprj('"+arraystr[i]+"') style=\"cursor:hand\"></td></tr>");
	}
