...
<form id="inputForm" action="${ctx}/center/common/misd/project/saveDeploy" method="post" enctype="multipart/form-data" class="validate">
<quick:backPageUrl />
		           ...
		           <tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
		              <tr>
		                ...
		                <td width="35%"><b><quick:navigation name="世纪桥工程部署" /></b></td>
        ...
        <td>
		  <fieldset ><legend>&nbsp;基本信息&nbsp;</legend>
			 <table style="width:100%" align="center" class="TableBlock" >
			    <tr>
					<td width="20%" align="left" class="TableContent">选择部署的文件:</td>
